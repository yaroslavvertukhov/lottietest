...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.locale = {
            direction: 'ltr',
            format: moment.localeData('ru').longDateFormat('L'),
            separator: ' - ',
            applyLabel: 'Apply',
            cancelLabel: 'Cancel',
            weekLabel: 'W',
            ...
            firstDay: moment.localeData('ru').firstDayOfWeek()
        };
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var dateHtml = this.locale.monthNames[calendar[1][1].month()][0].toUpperCase() + this.locale.monthNames[calendar[1][1].month()].slice(1) + calendar[1][1].format(" YYYY");
